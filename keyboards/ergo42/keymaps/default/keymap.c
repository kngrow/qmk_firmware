...
[BASE] = KEYMAP( \
  ...
  KC_LALT,  KC_A,    KC_S,   KC_D,    KC_F,             KC_G,           S(KC_RBRC),    S(KC_BSLS), KC_H,             KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT, \
  KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,             KC_B,           S(KC_8),       S(KC_9),    KC_N,             KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  SFT_T(KC_RO), \
