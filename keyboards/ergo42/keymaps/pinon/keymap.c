...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | LGUI | LCtrl| LGUI | LAlt | LOWER | LOWER|Space|   | enter| RAISE| RAISE| ARROW| LEFT | DOWN | RIGHT|
   * `------------------------------------------------'   `------------------------------------------------'
   */
  ...
  [BASE] = LAYOUT( \
    ...
    KC_ESC,  KC_ESC, KC_LGUI,KC_LALT, MO(LOWER), MO(LOWER), KC_SPC, KC_ENT, MO(RAISE), MO(RAISE), MO(ARROW), KC_DOWN, KC_DOWN, MO(GAME) \
  ),
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | LGUI | LCtrl| LGUI | LAlt | LOWER | LOWER|Space|   | enter| RAISE| RAISE|  RAlt| LEFT | DOWN | RIGHT|
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [LOWER] = LAYOUT( \
    KC_TILD, S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_5),S(KC_6), S(KC_7), S(KC_8), S(KC_9),    S(KC_0),  S(KC_EQL), \
    _______, KC_F1,   KC_F2, KC_F3, KC_F4, KC_F5, KC_LBRC,    KC_RBRC, KC_LEFT, S(KC_MINS), S(KC_EQL), S(KC_LBRC), S(KC_RBRC), S(KC_BSLS), \
  ...
  [RAISE] = LAYOUT( \
    ...
    _______, KC_F1,   KC_F2, KC_F3, KC_F4, KC_F5, S(KC_LBRC),    S(KC_RBRC), S(KC_7), KC_MINS    , KC_EQL, KC_LBRC,   KC_RBRC, KC_BSLS, \
