...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [RAISE] = LAYOUT( \
    ...
    _______, KC_F1,   KC_F2, KC_F3, KC_F4, KC_F5, S(KC_LBRC),    S(KC_RBRC), S(KC_7), S(KC_MINS)    , S(KC_EQL), KC_LBRC,   KC_RBRC, S(KC_BSLS), \
  ...
  [GAME] = LAYOUT( \
    ...
    _______, KC_F1,   KC_F2, KC_F3, KC_F4, KC_F5, AG_NORM,     AG_SWAP,_______,_______,_______, KC_UP, KC_RGHT,_______, \
