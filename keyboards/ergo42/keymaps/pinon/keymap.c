...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | LGUI | LCtrl| LGUI | LAlt | META | META |Space |   | enter| SYMB | SYMB |   =  | LEFT | DOWN | RIGHT|
   * `------------------------------------------------'   `------------------------------------------------'
   */
  ...
  [BASE] = LAYOUT( \
    ...
    XXXXXXX,  XXXXXXX, KC_LGUI, KC_LALT, MO(META), MO(META), KC_SPC, KC_ENT, MO(SYMB), MO(SYMB), KC_EQL, KC_LEFT, KC_DOWN, MO(GAME) \
  ),
  ...
  [META] = LAYOUT( \
    ...
    _______, KC_F1,   KC_F2, KC_F3, KC_F4, KC_F5, _______, _______, KC_LEFT, S(KC_MINS), KC_UP, KC_RGHT, XXXXXXX, XXXXXXX, \
  ...
  [SYMB] = LAYOUT( \
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, S(KC_7), S(KC_8), KC_MINS,    XXXXXXX,   S(KC_SCLN), S(KC_QUOT), \
